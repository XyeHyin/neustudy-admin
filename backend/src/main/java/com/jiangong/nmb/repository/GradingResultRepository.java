...
public interface GradingResultRepository extends JpaRepository<GradingResult, Long> {
    ...
    @Query("SELECT r FROM GradingResult r WHERE r.finalScore IS NULL " +
           "AND r.studentAnswer.question.type NOT IN (com.jiangong.nmb.entity.Question.QuestionType.SINGLE_CHOICE, " +
           "com.jiangong.nmb.entity.Question.QuestionType.MULTIPLE_CHOICE, " +
           "com.jiangong.nmb.entity.Question.QuestionType.TRUE_FALSE) " +
