...
import com.jiangong.nmb.dto.paper.PaperQuestionDTO;
import com.jiangong.nmb.dto.paper.SmartPaperDTO;
...
public class PaperService {
    ...
    public void addQuestions(Long paperId, List<PaperQuestionDTO> dtos, Long currentUserId) {
        ...
        for (PaperQuestionDTO dto : dtos) {
            ...
            pq.setPaper(paper);
            pq.setQuestion(new com.jiangong.nmb.entity.Question());
    ...
    public PaperStatisticsVO statistics(Long paperId) {
        ...
        if (!sessions.isEmpty()) {
            ...
            for (PaperQuestion pq : paperQuestions) {
                ...
                for (PracticeSession s : sessions) {
                    List<com.jiangong.nmb.entity.StudentAnswer> answers = s.getAnswers();
                    if (answers != null) {
                        for (com.jiangong.nmb.entity.StudentAnswer a : answers) {
